...
public class GroupSettingsActivity extends AppCompatActivity {
    ...
    String UID, group = "", treasurer = "", chair = "", secretary = "";
    ...
    private void initVars() {
        ...
        groupChair = findViewById(R.id.groupChair);
        groupSecretary = findViewById(R.id.groupSecretary);
        groupTreasurer = findViewById(R.id.groupTreasurer);
    ...
    private void loadGroup() {
        ...
        dbRef.child("Groups").child(group).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                chair = Objects.requireNonNull(snapshot.child("chair").getValue()).toString();
                secretary = Objects.requireNonNull(snapshot.child("secretary").getValue()).toString();
                treasurer = Objects.requireNonNull(snapshot.child("treasurer").getValue()).toString();
    ...
    private void saveGroupInfo() {
        ...
        dbRef.child("MyGroups").child(UID).child(group).child("chair").setValue(chair);
        ...
        dbRef.child("Groups").child(group).child("chair").setValue(chair);
        dbRef.child("Groups").child(group).child("secretary").setValue(secretary);
        dbRef.child("Groups").child(group).child("treasurer").setValue(treasurer);
    }
    ...
    private void loadMembers() {
        ...
        dbRef.child("GroupMembers").child(group).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        groupChair.setTitle("Choose Chair");
        groupChair.setPositiveButton("Cancel");
        groupChair.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        groupSecretary.setTitle("Choose Secretary");
        groupSecretary.setPositiveButton("Cancel");
        groupSecretary.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    GroupMembers ld = (GroupMembers) parent.getItemAtPosition(position);
        ...
        groupTreasurer.setTitle("Choose Treasurer");
        groupTreasurer.setPositiveButton("Cancel");
        groupTreasurer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    GroupMembers ld = (GroupMembers) parent.getItemAtPosition(position);
